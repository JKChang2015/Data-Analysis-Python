...
over_5000 = len(bikes[bikes["cnt"] > 5000])
prob_over_5000 = over_5000 / len(bikes)
...
plt.bar(outcome_counts,[binom.pmf(x,30,0.39) for x in outcome_counts])
...
outcome_counts = linspace(0,30,31)
outcome_probs = [binom.cdf(i, 30,0.39) for i in outcome_counts]
plt.plot(outcome_probs)
plt.show()
