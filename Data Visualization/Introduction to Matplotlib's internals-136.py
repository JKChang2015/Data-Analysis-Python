...
ax.set(xlim=(0,13), ylim=(10,110),xlabel = "Month", ylabel = "Temperature", title = "Month vs Temperature")
...
ax1.set(title = "2013", xlim = [0,13], ylim = [10,110])

ax2 = fig.add_subplot(2,1,2)
ax2.scatter(month_2014,temperature_2014,color = 'darkgreen',marker = 'o')
ax2.set(title = '2014', xlim = [0,13], ylim = [10,110])
plt.show()