...
def find_common(year):
    requested_years = sentences_cia[sentences_cia["year"] == year]
    combined_years = " ".join(requested_years)
    split_years_list = combined_years.split(" ")
    filter_words = [s for s in split_years_list if len(s) > 4]
    filtered_words_counter = Counter(filter_words)
    return filtered_words_counter.most_common(2)

common_2000 = find_common("2000")
common_2002 = find_common("2002")
common_2013 = find_common("2013")