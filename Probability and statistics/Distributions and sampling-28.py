...
deviations_from_mean = (0.18 - numpy.mean(large_sample)) / large_sample_std
over_18_count = len([x for x in large_sample if x >= 0.18])
...
median_income = [select_random_sample(100)["median_income"].mean() for _ in range(1000)]
plt.hist(median_income, bins = 20)
plt.show()
