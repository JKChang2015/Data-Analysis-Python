...
from facts where population > 0 and population < 7000000000;
'''
...
select round(population + population * population_growth, 0) from facts
...
conn = sqlite3.connect("factbook.db")
proj_pop_query = '''
select round(min(population + population * population_growth), 0), 
round(max(population + population * population_growth), 0), 
round(avg(population + population * population_growth), 0)
from facts 
